...
| app内file browserの範囲選択 | folder内の全選択と、長押し+dragでの範囲選択を加える | `008:T07`の実機確認で開発者が挙げ、2026-09-21に`008:T36`(仕様) / `T37`(実装)へ昇格した。004 REQ-020をT36で承認済み。入口・近道の提示(`T11`/`T12`)とは別の論点である |
