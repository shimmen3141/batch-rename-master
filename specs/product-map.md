...
| 008 UIと主要操作の整合 | 005完了を受けて計画済み。並び順control、選択と除去、token追加、行と警告の情報階層をT01〜T07へ分解した | [`008-ui-alignment/`](008-ui-alignment/) |
| 013 Android安全rename | 005の安全なunsupportedが統合済み。`T01`はAI containerから公式資料へ到達できず、進め方の判断待ち | [`013-safe-android-rename/`](013-safe-android-rename/) |
