...
| [003-rule-builder](003-rule-builder/plan.md) | in_progress | approved (Light) | 5/6 | 002-file-list | 命名ルールを組み立てる UI。トークン(元のファイル名 / 自由テキスト / 区切り / 連番 / 日時)を Chip |
| [004-file-source](004-file-source/plan.md) | in_progress | approved (Light) | 5/6 | 002-file-list | 実ファイルの読み込みを担う。抽象ポート `FileSource` を定義し、(a) フォルダを選んで権限を取得しフォルダ |
