...
| [007-rule-persistence](007-rule-persistence/plan.md) | approved | approved (Light) | 3/5 | 003-rule-builder | 直近に組み立てた「現在のルール」1件を永続化し、次回アプリ起動時にそのルールから始められるようにする。中核は 001 の |
