...
|------|------|------|------|--------------|------|
| [001-rename-core](001-rename-core/plan.md) | done | draft (Strict) | 6/6 | - | 一括リネームアプリの中核となる**純粋 Dart の命名エンジン**を、UI・ファイルIO・プラットフォーム固有処理から |
...
| [004-file-source](004-file-source/plan.md) | in_progress | draft (Light) | 3/6 | 002-file-list | 実ファイルの読み込みを担う。抽象ポート `FileSource` を定義し、(a) フォルダを選んで権限を取得しフォルダ |
