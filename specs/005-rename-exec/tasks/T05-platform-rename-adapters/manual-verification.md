...
- Commit: PR #116の最新head（product code baseline: `b866e35b50307e26d0eb90f77d1721782243b32a`。exact headはIssue/PRへ記録する）
- Build/artifact: pending — 上記latest headから作成したartifact識別情報を記録する
