...
5. OFFのまま実行button(`N 件をリネーム`)を押します。
6. 確認します。
...
5. ルールはステップ1と同じ(`元の名前` + `_m`)のまま、実行button(`N 件をリネーム`)を押します。
6. 確認します。
...
4. 「更新日時を一覧の並び順にずらす」がONのまま、実行button(`N 件をリネーム`)を押します。
5. 確認します。
