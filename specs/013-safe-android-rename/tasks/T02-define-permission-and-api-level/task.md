...
- 2026-08-24 / **このtaskが所有する`spec.md`のREQ-001へ、`013:T06`のbranchで1文を追記した(開発者承認)。** 「利用者が読み込もうとして以降」。**採らなかった読みを排除したもので、要求を広げていない。** 詳細は`spec.md`のStatus節と`plan.md`の決定表、`T06/task.md`。
