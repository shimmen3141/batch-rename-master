...
[`docs/design/Bulk Renamer.html`](../../../../docs/design/Bulk%20Renamer.html)は005 UIの**配置・導線・情報階層の土台**である(`AGENTS.md`。**正本ではない** — 作成時から仕様と認識が変わっているため。この言い回しの変更はPR #140)。対象taskは適用画面範囲を明記し、土台から離れるときは離れた点と理由を書く。
