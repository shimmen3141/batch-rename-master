...
**`T04`の未決定は無い**(revision 4は2026-08-14に承認済み)。残る未決定は`T03`(004の読み込み導線)と、契約の`open_questions` **OQ-001〜OQ-008**である。**OQ-001・OQ-005・OQ-007・OQ-008は`T11`が決着させた**(実装が契約と食い違ったまま`dev`に入っている)。**OQ-002・OQ-003・OQ-004・OQ-006を`T10`が決め、8件まとめて契約revision 5として戻す。**
